...
The widget includes a comprehensive demo app (`demo_smart_appbar.dart`) that showcases:
...
Run the test suite:
```bash
flutter test test/smart_appbar_test.dart
```
...
```
lib/
├── smart_appbar.dart          # Main SmartAppBar widget
├── demo_smart_appbar.dart     # Complete demo app
test/
